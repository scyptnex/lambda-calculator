...
public class TestTransformEvent {
    ...
    public void stupidMandatoryCoverage(){
        assertThat(TransformationEvent.TransformType.values().length, is(4));
        ...
        assertThat(TransformationEvent.TransformType.valueOf("DELTA"), is(TransformationEvent.TransformType.DELTA));
    }
